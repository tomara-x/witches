...
;fm--------------------------------
kFC[] fillarray 3, 3, 4, 2, 4
kFBS, kFBT[] utBasemath kBT, kFC ;FMBasmaStep, FMBasmaTrigger array
kFN[] fillarray 3,20, 4, 3, 6, 7, 8, 0  ;FMNotes
kFN += 4
kFG[] fillarray 0, 1, 0, 2, 0, 1, 0, 0  ;FMGain (transposition)
kFTS, kFTP[], kFTT[] Taphath kFBT[kFBS], kFN,kFG,kBQ, iBS
schedkwhen(kTL[2],0,0, "FM10", 0, -1)
schedkwhen(release(),0,0, -nstrnum("FM10"), 0, 1) ;cute! release is a trigger signal
gkCps = kFTP[kFTS]*2
gkRat = 1
gkRat[13] = .5
gkRat[06] = 2
...
gkAmp[09] = randomi(0, .9, 5)
gkAmp[10] = randomi(0, .1, 5)
gkAmp[11] = randomi(0, .6, 5)
gkAmp[12] = randomi(0, .8, 5)
...
ga_sbus[3][0] diode_ladder ga_sbus[3][0], kCO, 10, 1, kFB
ga_sbus[3][1] diode_ladder ga_sbus[3][1], kCO, 10, 1, kFB
