...
instr Bambo
aSig bamboo p4, p3, 100, .01, .0, 407, 268, 790
;aSig limit aSig, -.5, .5
...
kCount[]    fillarray 1, 1, 4, 4, 4, 4, 4, 4
...
kDrmFrq init $TEMPO/60
kDT     metro kDrmFrq ;DrumTrigger
kDC[]   fillarray 1, 1, 1, 1
kDBS, kDBT[] utBasemath kDT, kDC
if kS = 0 then
kDrmFrq = $TEMPO/60
schedkwhen(kDBT[0],0,0, "Cabasa",0,ib, .1)
schedkwhen(kDBT[1],0,0, "Cabasa",0,ib, .1)
schedkwhen(kDBT[2],0,0, "Cabasa",0,ib, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",0,ib, .1)
endif
if kS = 1 then
kDrmFrq = $TEMPO/60
schedkwhen(kDBT[0],0,0, "Cabasa",0,ib, .1)
;schedkwhen(kDBT[1],0,0, "Cabasa",0*ib/2,ib/2, .1)
schedkwhen(kDBT[1],0,0, "Cabasa",1*ib/2,ib/2, .1)
schedkwhen(kDBT[2],0,0, "Cabasa",0,ib, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",0,ib, .1)
endif
if kS = 2 then
kDrmFrq = $TEMPO*4/60
schedkwhen(kDBT[0],0,0, "Cabasa",0,ib/4, .2)
schedkwhen(kDBT[1],0,0, "Cabasa",0,ib/4, .1)
schedkwhen(kDBT[2],0,0, "Cabasa",0,ib/4, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",0,ib/4, .1)
endif
if kS = 3 then
kDrmFrq = $TEMPO/60
schedkwhen(kDBT[0],0,0, "Cabasa",0,ib, .2)

schedkwhen(kDBT[1],0,0, "Cabasa",0*ib/3,ib/3, .1)
schedkwhen(kDBT[1],0,0, "Cabasa",1*ib/3,ib/3, .1)
schedkwhen(kDBT[1],0,0, "Cabasa",2*ib/3,ib/3, .1)

schedkwhen(kDBT[2],0,0, "Cabasa",0,ib, .1)

schedkwhen(kDBT[3],0,0, "Cabasa",0*ib/5,ib/5, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",1*ib/5,ib/5, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",2*ib/5,ib/5, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",3*ib/5,ib/5, .1)
schedkwhen(kDBT[3],0,0, "Cabasa",4*ib/5,ib/5, .1)
endif
if kS = 4 then
schedkwhen(kDBT[0],0,0, "Cabasa",0*ib/5,ib/5, .1)
schedkwhen(kDBT[0],0,0, "Cabasa",1*ib/5,ib/5, .1)
schedkwhen(kDBT[0],0,0, "Cabasa",2*ib/5,ib/5, .1)
schedkwhen(kDBT[0],0,0, "Cabasa",3*ib/5,ib/5, .1)
schedkwhen(kDBT[0],0,0, "Cabasa",4*ib/5+0*ib/5/3,ib/5/3, .1)
;schedkwhen(kDBT[0],0,0, "Cabasa",4*ib/5+1*ib/5/3,ib/5/3, .1)
schedkwhen(kDBT[0],0,0, "Cabasa",4*ib/5+2*ib/5/3,ib/5/3, .1)
