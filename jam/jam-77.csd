...
gkPch2[] fillarray 7.02, 6.04, 6.09, 6.11, 6.07, 6.09, 6.11, 7.00,
                   9.00, 9.02, 9.04, 9.06, 9.07, 9.09, 9.11, 10.00
gkPch3[] fillarray 6.07, 9.09, 6.11, 8.04, 6.07, 6.09, 6.11, 7.00,
                   9.00, 9.02, 9.04, 9.06, 9.07, 9.09, 9.11, 10.00
endin
schedule("Arr", 0, 1/kr)
...
if kTrig == 1 then
    kN = node_climb3(0)
    schedulek "String",0,$BEAT, 0.2, cpspch(gkPch1[kN]), 0.2, 0.8, 0.9
    schedulek "String",0,$BEAT, 0.3, cpspch(gkPch2[kN]), 0.4, 0.8, 0.9
    schedulek "String",0,$BEAT, 0.1, cpspch(gkPch3[kN]), 0.2, 0.8, 0.8
    kCnt += 1
endif
if kCnt == 4 then
    schedulek "Response", $BEAT, -1
    gkPch1[2] = gkPch1[2] + 0.01
    gkPch2[2] = gkPch2[2] + 0.01
    gkPch3[2] = gkPch3[2] + 0.01
    turnoff
endif
endin
...
if kTrig == 1 then
    kN = node_climb3(8)
    schedulek "String",0,$BEAT, 0.2, cpspch(gkPch1[kN]), 0.2, 0.5, 0.2
    kCnt += 1
endif
if kCnt == 4 then
...
;aSig wguide1 aSig, 4.999, 21000, 0.7
vincr gaVerbL, aSig*db(-6)
vincr gaVerbR, aSig*db(-6)
sbus_mix 1, aSig
clear gaString
endin
